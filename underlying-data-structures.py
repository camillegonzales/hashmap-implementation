# Description: Provided data structures necessary to implement two forms of HashMap, 
#              Separate Chaining(SC) and Open Addressing(OA) with Quadratic Probing.
#              Includes two simple hash functions.
